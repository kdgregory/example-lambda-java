...
#
#   cognite-create-userpool.sh POOL_NAME
#
...
aws cognito-idp create-user-pool-client --user-pool-id $USER_POOL_ID --client-name $1 --cli-input-json file:///tmp/$$-clientdef.json > /tmp/$$-clientdef-output.json
